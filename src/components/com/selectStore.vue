      ...
      <el-col style="width: 240px;" v-show="groupwrap">
        <div class="groupwrap" @click="showGroup">
          ...
          <div class="grouptree" v-show="showGroupTree">
            <el-tree @check="checkedStore" :data="data" show-checkbox node-key="id" :default-expanded-keys="[1]" :props="defaultProps"> </el-tree>
          </div>
        </div>
      </el-col>
      <el-col style="width: 240px;" v-show="partstore">
        <el-select v-model="partvalue" @change="changePartStore" multiple filterable remote reserve-keyword placeholder="请输入关键词" :remote-method="remoteMethod" :loading="loading">
